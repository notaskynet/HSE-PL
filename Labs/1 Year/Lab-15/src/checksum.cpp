...
namespace{
    std::mutex calculate_hash_mtx;
    std::mutex parse_cmd_checksum_mtx;
    std::mutex parse_file_checksum_mtx;
}
...
std::string calculateHash(
    ...
    std::lock_guard<std::mutex> calculate_hash_ul(calculate_hash_mtx);
    std::string hash;
    std::string cmd;
...
std::vector<Checksum> parseChecksum(
    ...
    std::lock_guard<std::mutex> parse_file_checksum_ul(parse_file_checksum_mtx);
...
std::vector<Checksum> parseChecksum(
    ...
    std::lock_guard<std::mutex> parse_cmd_checksum_ul(parse_cmd_checksum_mtx);
